...
namespace ProjectCode1.InGame.Skills
{
    /// <summary>
    /// Skill1031: BreathIce - 
    /// Idle: EbonyWings VS but it is ice dragon and have slow
    /// </summary>
    public class Skill1031 : Skill
    {
        ...
        [SerializeField] private Skill1031Projectile projectilePrefab;
        ...
        private ObjectPool<Skill1031Projectile> projectilePool;
        private float timeSinceLastCast;
        private bool isCasting;
        private Vector3 moveDirection;

        public float MoveSpeed { get => Mathf.Clamp(owner.stats.speed / 3, 1, owner.stats.speed); }
        ...
        public float SlowAmount { get => slowAmount; }
        ...
        void Start()
        {
            ...
            projectilePool = new ObjectPool<Skill1031Projectile>(
                () =>
                {
        ...
        public void DespawnProjectile(Skill1031Projectile projectile)
        {
